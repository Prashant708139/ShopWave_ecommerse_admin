    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs">
          <p className="text-xs text-slate-400 font-medium">Gross Revenue (YTD)</p>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs">
          <p className="text-xs text-slate-400 font-medium">Avg Order Value (AOV)</p>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs">
          <p className="text-xs text-slate-400 font-medium">Store Conversion Rate</p>
          <p className="text-2xl font-bold text-purple-600 mt-1">3.48%</p>
          <span className="text-[11px] text-purple-600 font-semibold">Industry Benchmark: 2.5%</span>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs">
          <p className="text-xs text-slate-400 font-medium">Return & Refund Rate</p>
          <p className="text-2xl font-bold text-slate-800 mt-1">1.2%</p>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-xs overflow-hidden">
        <div className="p-4 border-b border-slate-100 flex items-center justify-between">
          <h3 className="font-bold text-slate-800 text-sm">Top Revenue Generators</h3>
          <span className="text-xs text-slate-400">Ranked by gross sales</span>
        </div>
